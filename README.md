...
## Conclusions
- The R-squared value of the train set is 80.03% whereas the test set has a value of 79.69% which suggests that our model broadly explains the variance quite accurately on the test set and thus we can conclude that it is a good model.
...
## Contact
Created by [@iphilip] - feel free to contact me!
